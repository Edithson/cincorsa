<!-- Section 2: Nos Clients / Références -->
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-16 animate-fadeInUp">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Des organisations publiques et privées de premier plan nous choisissent pour sécuriser et optimiser
                leur gestion documentaire
            </p>
        </div>

        <!-- Client Sectors -->
        <div class="grid md:grid-cols-3 gap-8 mb-0">
            <!-- Sector 1 -->
