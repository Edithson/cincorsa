        ...
        <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] p-8 md:p-16 shadow-2xl overflow-hidden relative">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="lg:w-1/3 w-full flex flex-col gap-4">
                    <a href="#contact" class="group relative flex items-center justify-center bg-emerald-600 text-white px-8 py-5 rounded-2xl font-bold text-lg hover:bg-emerald-500 transition-all duration-300 shadow-xl shadow-emerald-900/20 overflow-hidden">
                    ...
                    <button class="flex items-center justify-center border border-white/10 text-white px-8 py-5 rounded-2xl font-bold text-lg hover:bg-white/5 transition-all">
