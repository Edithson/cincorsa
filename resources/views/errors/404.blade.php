...
<div class="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center">
    ...
    <div class="w-24 h-24 bg-blue-50 text-blue-500 rounded-3xl flex items-center justify-center mb-6 shadow-sm border border-blue-100">
    ...
    <a href="{{ route('admin_dashboard') }}" class="bg-slate-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-slate-800 transition-all">Retour à l'accueil</a>
</div>
@endsection
